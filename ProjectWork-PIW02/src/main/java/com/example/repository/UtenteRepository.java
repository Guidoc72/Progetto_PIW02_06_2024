...
public interface UtenteRepository extends JpaRepository<Utente, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO utenti (ruolo, nome, cognome, mail, password_utente, abilitato) VALUES (:ruolo, :nome, :cognome, :mail, :password_utente, :abilitato)", nativeQuery = true)
    void salvaUtente(@Param("ruolo") Long ruolo, @Param("nome") String nome, @Param("cognome") String cognome, @Param("mail") String mail, @Param("password_utente") String password, @Param("abilitato") Boolean abilitato);
